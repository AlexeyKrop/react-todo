...
export const todolistReducer = (state: Array<TodoListType>, action: todoListACType): Array<TodoListType>  => {
  switch (action.type) {
...
export const changeTodolistTitleAC = (todoListId: string, changeTitle: string): ChangeTodolistTitleAT => ({
